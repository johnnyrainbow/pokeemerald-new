...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    {.iv = 200,
     ...
     .moves = {MOVE_ROCK_SLIDE, MOVE_THUNDER_WAVE, MOVE_BODY_SLAM, MOVE_ROCK_TOMB}}};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    {.iv = 200,
     ...
     .species = SPECIES_MAGCARGO,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER, MOVE_LIGHT_SCREEN, MOVE_SUNNY_DAY}},
    {.iv = 250,
     .lvl = 28,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    {.iv = 200,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_BULK_UP, MOVE_REST, MOVE_SLEEP_TALK, MOVE_BODY_SLAM}},
    {.iv = 250,
     .lvl = 32,
