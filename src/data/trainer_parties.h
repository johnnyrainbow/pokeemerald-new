...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    {.iv = 200,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}},
    {.iv = 200,
     .lvl = 15,
    ...
    {.iv = 200,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SPARK, MOVE_HARDEN, MOVE_TACKLE, MOVE_ROCK_TOMB}},
    {.iv = 200,
     .lvl = 14,
     .species = SPECIES_STEELIX,
     .heldItem = ITEM_CHESTO_BERRY,
     .moves = {MOVE_ROCK_SLIDE, MOVE_ROAR, MOVE_BODY_SLAM, MOVE_ROCK_TOMB}}};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    {.iv = 200,
     ...
     .moves = {MOVE_MACH_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH}}};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    {.iv = 250,
     ...
     .species = SPECIES_ELECTRODE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_THUNDERBOLT, MOVE_BODY_SLAM, MOVE_SELF_DESTRUCT, MOVE_SHOCK_WAVE}},
    {.iv = 250,
     .lvl = 23,
     .species = SPECIES_PIKACHU,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_THUNDERBOLT, MOVE_IRON_TAIL, MOVE_QUICK_ATTACK, MOVE_DOUBLE_EDGE}},
    {.iv = 250,
     .lvl = 23,
     .species = SPECIES_MAGNETON,
     .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    {.iv = 250,
     ...
     .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_SUNNY_DAY, MOVE_ATTRACT}},
    {.iv = 200,
     .lvl = 26,
     .species = SPECIES_ARCANINE,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EXTREME_SPEED, MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_ROAR}},
    {.iv = 250,
     .lvl = 28,
     .species = SPECIES_MOLTRES,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_FIRE_BLAST, MOVE_AERIAL_ACE, MOVE_SUNNY_DAY, MOVE_THUNDERBOLT}},
    {.iv = 250,
     .lvl = 29,
     .species = SPECIES_TORKOAL,
     .heldItem = ITEM_WHITE_HERB,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    {.iv = 220,
     ...
     .species = SPECIES_LINOONE,
     .heldItem = ITEM_SITRUS_BERRY,
     .moves = {MOVE_EXTREME_SPEED, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_HEADBUTT}},
    {.iv = 200,
     .lvl = 31,
     .species = SPECIES_KANGASKHAN,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_EARTHQUAKE, MOVE_DIZZY_PUNCH, MOVE_FAKE_OUT, MOVE_BODY_SLAM}},
    {.iv = 250,
     .lvl = 32,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    {.iv = 210,
     ...
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_ICE_BEAM, MOVE_SURF, MOVE_CALM_MIND, MOVE_AERIAL_ACE}},
    {.iv = 210,
     .lvl = 32,
     .species = SPECIES_TROPIUS,
     .heldItem = ITEM_NONE,
    ...
    {.iv = 210,
     ...
     .species = SPECIES_PELIPPER,
     .heldItem = ITEM_LEFTOVERS,
     .moves = {MOVE_WATER_PULSE, MOVE_SUPERSONIC, MOVE_ICE_BEAM, MOVE_AERIAL_ACE}},
    {.iv = 220,
     .lvl = 34,
     .species = SPECIES_SKARMORY,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_SAND_ATTACK, MOVE_MIRROR_COAT, MOVE_STEEL_WING, MOVE_AERIAL_ACE}},
    {.iv = 250,
     .lvl = 34,
     .species = SPECIES_ALTARIA,
     .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    {.iv = 200,
     ...
     .heldItem = ITEM_NONE,
     .moves = {MOVE_RAIN_DANCE, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_SURF}},
    {.iv = 220,
     .lvl = 45,
     .species = SPECIES_LUVDISC,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_WATER_PULSE, MOVE_ATTRACT, MOVE_ICE_BEAM, MOVE_CALM_MIND}},
    {.iv = 230,
     .lvl = 46,
     .species = SPECIES_WHISCASH,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}},
    {.iv = 230,
     .lvl = 47,
     .species = SPECIES_WALREIN,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_EARTHQUAKE, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_WATER_PULSE}},
    {.iv = 250,
     .lvl = 46,
     .species = SPECIES_CRAWDAUNT,
     .heldItem = ITEM_NONE,
     .moves = {MOVE_CALM_MIND, MOVE_CRABHAMMER, MOVE_THUNDER_PUNCH, MOVE_LEAF_BLADE}},
    {.iv = 250,
     .lvl = 46,
     .species = SPECIES_KINGDRA,
     .heldItem = ITEM_CHESTO_BERRY,
